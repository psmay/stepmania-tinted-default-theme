...
if lang ~= "en" and FILEMAN:DoesFileExist(cur_dir.."ready (lang "..lang..").png") then
	return LoadActor("ready (lang "..lang..")") .. {
		...
		StartTransitioningCommand=cmd(zoom,1.3;diffusealpha,0;bounceend,0.25;zoom,1;diffusealpha,1;linear,0.15;glow,BoostColor(ColorSchemeColors.VeryShallow,1.75);decelerate,0.3;glow,1,1,1,0;sleep,1-0.45;linear,0.25;diffusealpha,0;);
	};
else
