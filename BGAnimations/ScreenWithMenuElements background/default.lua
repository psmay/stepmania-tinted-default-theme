...
t[#t+1] = Def.ActorFrame {
  ...
  InitCommand=cmd(Center);
	Def.Quad {
		...
		OnCommand=cmd(diffuse,ColorSchemeColors.Main;diffusebottomedge,ColorSchemeColors.OffMain);
	};
	Def.ActorFrame {
		...
		LoadActor("_checkerboard") .. {
			...
			OnCommand=cmd(texcoordvelocity,0,0.25;diffuse,ColorSchemeColors.Deep;fadetop,1);
		};
	};
